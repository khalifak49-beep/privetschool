        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentPath = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Points = table.Column<decimal>(type: "numeric(4,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedEntity = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolNameEn = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    SchoolStartTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    SchoolEndTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    LateGraceMinutes = table.Column<int>(type: "integer", nullable: false),
                    AutoNotifyGuardianOnAbsence = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BusNo = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    PlateNo = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ...
                    LicenseExpiry = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassScore = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DropTime = table.Column<TimeSpan>(type: "interval", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    FullNameEn = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    NationalId = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    Gender = table.Column<int>(type: "integer", nullable: false),
                    BirthDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ...
                    Religion = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    Address = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    Phone = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    Email = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    PhotoPath = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CurrentSectionId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    PreviousSchool = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    QrToken = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyGuardian = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToSectionId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    InvoiceId = table.Column<int>(type: "integer", nullable: false),
                    FeeItemId = table.Column<int>(type: "integer", nullable: true),
